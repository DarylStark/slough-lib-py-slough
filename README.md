...
This is a CLI tool to work with a Slough configuration file. This configuration file is a YAML file that contains the configuration for Slough. The tool allows you to create, update, and delete Slough configurations. These configuration can be used for CI/CD pipelines, local development, and other use cases.
